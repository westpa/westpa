    ...
    def add_args(self, parser):
        ...
        iogroup.add_argument('-a', '--assignments', default='assign.h5',
                             help='''Bin assignments and macrostate definitions are in ASSIGNMENTS
                                (default: %(default)s).''')
        iogroup.add_argument('-o', '--output', dest='output', default='kintrace.h5',
...
with confidence intervals. See ``w_kinavg kintrace --help`` for more 
information.
...
``w_kinavg kintrace --help`` for more information.
...
(-a/--assignments, default "assign.h5"); see ``w_assign --help`` for more
information.
