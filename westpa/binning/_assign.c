/* Generated by Cython 0.18 on Tue Mar 26 11:33:44 2013 */
 ...
 */
      ...
      __Pyx_GOTREF(__pyx_t_2);
      __pyx_t_5 = PyObject_RichCompare(__pyx_t_2, __pyx_v_func_output_len, Py_NE); __Pyx_XGOTREF(__pyx_t_5); if (unlikely(!__pyx_t_5)) {__pyx_filename = __pyx_f[0]; __pyx_lineno = 149; __pyx_clineno = __LINE__; goto __pyx_L1_error;}
      __Pyx_DECREF(__pyx_t_2); __pyx_t_2 = 0;
 ...
 */
    __pyx_t_12 = (((PyObject *) __pyx_v_state_map.memview) != Py_None);
    if (__pyx_t_12) {
  ...
  __Pyx_RefNannySetupContext("assign_and_label (wrapper)", 0);
  {
    ...
    if (unlikely(__pyx_kwds)) {
      ...
      switch (pos_args) {
        ...
        case  2:
        if (likely((values[2] = PyDict_GetItem(__pyx_kwds, __pyx_n_s__npts)) != 0)) kw_args--;
        else {
        ...
        case  3:
        if (likely((values[3] = PyDict_GetItem(__pyx_kwds, __pyx_n_s__parent_ids)) != 0)) kw_args--;
        else {
        ...
        case  4:
        if (likely((values[4] = PyDict_GetItem(__pyx_kwds, __pyx_n_s__assign)) != 0)) kw_args--;
        else {
