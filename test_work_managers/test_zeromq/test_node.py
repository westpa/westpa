...
class TestZMQNode(ZMQTestBase,CommonWorkManagerTests):
    ...
    def setUp(self):
        ...
        self.test_wm.rr_endpoints.append(upstream_rr_endpoint)
        self.test_wm.ann_endpoints.append(upstream_ann_endpoint)
        
        self.test_node = ZMQNode(upstream_rr_endpoint, upstream_ann_endpoint)
        self.test_node.downstream_ann_endpoints.append(downstream_ann_endpoint)
        self.test_node.downstream_rr_endpoints.append(downstream_rr_endpoint)
    ...
    def tearDown(self):
        ...
        super(TestZMQNode,self).tearDown()
