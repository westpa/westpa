...
from westtools.aframe import (WESTAnalysisTool,ExtDataReaderMixin,BFDataManager)


class WBFImporter(ExtDataReaderMixin,BFDataManager,WESTAnalysisTool):
    def __init__(self):
    ...
    def import_trajectories(self):
        ...
        for filename in self.ext_input_filenames:
            ...
            west.rc.pstatus('Reading "{:s}" and storing as trajectory {:d}...'.format(filename, traj_id))
