...
class W_Reverse():
    ...
    def __init__(self, h5="west.h5", first_iter=1, last_iter=None, config_file="west.cfg", max_n_bstates=10000,
                 rst_file='seg.ncrst', output_bstates_dir="bstates_reverse", output_bstates_file="bstates.txt",
                 use_weights=True,temp_dir="temp_dir"):
        """
        Parameters
        ----------
        h5 : str
