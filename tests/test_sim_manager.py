...
@pytest.mark.parametrize("sim_manager_setup", ['west.cfg'], indirect=['sim_manager_setup'])
class TestSimManager(BaseTestSimManager):
    pass


@pytest.mark.parametrize('sim_manager_setup', ['west_mab.cfg'], indirect=['sim_manager_setup'])
class TestMABSimManager(BaseTestSimManager):
    pass


@pytest.mark.parametrize('sim_manager_setup', ['west_binless.cfg'], indirect=['sim_manager_setup'])
class TestBinlessSimManager(BaseTestSimManager):
    pass
