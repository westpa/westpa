...
class Test_Plothist(unittest.TestCase):
    ...
    def test_compare_avg_txt(self):
        ...
        os.system("plothist average pdist_ref.h5 0 -o hist_avg.pdf --text-output hist_avg.txt --first-iter 1 --last-iter 50")
        os.system("cat hist_avg.txt | tail -n +10 > hist_avg.txt")
    ...
    def test_compare_inst_txt(self):
        ...
        os.system("plothist instant pdist_ref.h5 0 -o hist_inst.pdf --text-output hist_inst.txt --iter 50")
        os.system("cat hist_inst.txt | tail -n +10 > hist_inst.txt")
