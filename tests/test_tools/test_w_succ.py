...
class Test_W_Succ(unittest.TestCase):
    ...
    def test_w_succ_output(self):
        ...
        ref_dir = os.path.join(os.path.dirname(os.getcwd()), "test_references") 
        ...
        self.assertTrue(filecmp.cmp("temp_test_output.txt", w_succ_ref), \
        "--output flag output file was not successfully generated")

        os.system("w_succ -o temp_test_o.txt")
        self.assertTrue(filecmp.cmp("temp_test_o.txt", w_succ_ref), \
        "-o flag output file was not successfully generated")
