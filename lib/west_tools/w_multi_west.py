...
from west.data_manager import n_iter_dtype
from westtools import (WESTTool, ProgressIndicatorComponent, WESTMultiTool)
...
ci_dtype = np.dtype([('iter_start', n_iter_dtype),
