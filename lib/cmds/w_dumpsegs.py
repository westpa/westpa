...
parser = west.rc.common_arg_parser('w_dumpsegs', description='''\
...
max_status_name_len = max(map(len,west.Segment.status_names.values()))
max_endpoint_type_len = max(map(len, west.Segment.endpoint_type_names.values()))
